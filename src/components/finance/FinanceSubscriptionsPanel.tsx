  ...
  return (
    <section className="space-y-5">
      <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
        <div><div className="flex items-center gap-2 text-sm font-medium text-primary"><CalendarClock className="h-4 w-4" /> Recurring payments</div><h2 className="mt-1 text-2xl font-bold">Subscriptions manager</h2><p className="mt-1 text-sm text-muted-foreground">Detected locally from timing and amount patterns. You stay in control of every result.</p></div>
