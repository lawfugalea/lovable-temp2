        ...
        {selectedChild && <>
          ...
          <section>
            ...
            <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-3">
              ...
              {!childMedicines.length && <Card className="md:col-span-2 xl:col-span-3"><CardContent className="py-10 text-center"><Pill className="mx-auto h-9 w-9 text-muted-foreground" /><p className="mt-3 font-medium">No saved medicines yet</p><p className="mt-1 text-sm text-muted-foreground">Use Record dose and enter the medicine name. It will be saved automatically for next time.</p><Button className="mt-4" size="sm" onClick={() => beginAction('dose')}>Record first dose</Button></CardContent></Card>}
            </div>
          </section>
