  ...
  return (
    <>
      <Head>
        ...
        <meta name="description" content="Sign in to your HouseFlow account to access your family's cozy home hub." />
      ...
      <main className="min-h-screen bg-cozy-warm flex items-center justify-center p-6">
        <div className="w-full max-w-md animate-cozy-bounce-in">
          ...
          <div className="text-center mt-4">
            <Link 
              href="/landing" 
              className="text-sm text-cozy-text-muted hover:text-cozy-primary transition-colors"
            >
              ← Back to Home
            </Link>
          </div>
